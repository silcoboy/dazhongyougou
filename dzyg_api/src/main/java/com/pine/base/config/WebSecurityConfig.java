...
import com.pine.base.filter.JwtAuthenticationEntryPoint;
import com.pine.base.filter.JwtRequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.csrf().disable()
                ...
                .antMatchers("/miniapi/**","/upload/**","/api/login", "/api/register", "/error/**", "/admin/**","/api/stu/readExcel").permitAll()
